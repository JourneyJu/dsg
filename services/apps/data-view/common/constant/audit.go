...
const (
	...
	LineStatusOnLine       = "online"        //已上线 ->上线
	LineStatusOffLine      = "offline"       //已下线 ->未上线
	LineStatusUpAuditing   = "up-auditing"   //上线审核中 ->未上线
	LineStatusDownAuditing = "down-auditing" //下线审核中 ->上线
	LineStatusUpReject     = "up-reject"     //上线审核未通过 ->未上线
	LineStatusDownReject   = "down-reject"   //下线审核未通过 ->上线
...
const (
	...
	AuditTypePublish     = "af-data-view-publish"
	AuditTypeOnline      = "af-data-view-online"
	AuditTypeOffline     = "af-data-view-offline"
)
