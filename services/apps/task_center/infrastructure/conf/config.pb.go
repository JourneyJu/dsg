...
var file_config_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x1a, 0x1e, 0x67, 0x6f, 0x6f, 0x67,
	...
	0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x52, 0x06, 0x73, 0x65, 0x72,
	0x76, 0x65, 0x72, 0x12, 0x24, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x44,
	...
	0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e,
	...
	0x17, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x53, 0x65, 0x72,
	...
	0x19, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x44, 0x61, 0x74,
	...
	0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x64, 0x65, 0x6d, 0x6f,
	...
	0x65, 0x6f, 0x75, 0x74, 0x42, 0x0e, 0x5a, 0x0c, 0x2e, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f,
...
var file_config_proto_goTypes = []interface{}{
	(*Bootstrap)(nil),         // 0: proto_demo.Bootstrap
	(*Server)(nil),            // 1: proto_demo.Server
	(*Data)(nil),              // 2: proto_demo.Data
	(*Server_HTTP)(nil),       // 3: proto_demo.Server.HTTP
	(*Server_GRPC)(nil),       // 4: proto_demo.Server.GRPC
	(*Data_Database)(nil),     // 5: proto_demo.Data.Database
	(*Data_Redis)(nil),        // 6: proto_demo.Data.Redis
	(*duration.Duration)(nil), // 7: google.protobuf.Duration
}
var file_config_proto_depIdxs = []int32{
	1,  // 0: proto_demo.Bootstrap.server:type_name -> proto_demo.Server
	2,  // 1: proto_demo.Bootstrap.data:type_name -> proto_demo.Data
	3,  // 2: proto_demo.Server.http:type_name -> proto_demo.Server.HTTP
	4,  // 3: proto_demo.Server.grpc:type_name -> proto_demo.Server.GRPC
	5,  // 4: proto_demo.Data.database:type_name -> proto_demo.Data.Database
	6,  // 5: proto_demo.Data.redis:type_name -> proto_demo.Data.Redis
	7,  // 6: proto_demo.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	7,  // 7: proto_demo.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	7,  // 8: proto_demo.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	7,  // 9: proto_demo.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
