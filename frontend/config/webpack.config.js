...
// 预热
threadLoader.warmup(commonWorkerPool, ['babel-loader'])
...
const entryFiles = [
    ...
    {
        name: "dataOperationAudit",
        template: paths.dataOperationAuditHtml,
        htmlFilename: 'dataOperationAudit.html',
    },
    {
        name: "download",
        template: paths.downloadHtml,
        htmlFilename: 'download.html',
    },
    {
        name: "dmdAudit",
        template: paths.dmdAuditHtml,
        htmlFilename: 'dmdAudit.html',
    },
    {
        name: "afPluginFrameworkForAs",
        template: paths.afPluginFrameworkForAsHtml,
...
module.exports = function (webpackEnv) {
    ...
    const webpackConfig = {
        ...
        entry: {
            workbench: paths.appIndexJs,
            dataOperationAudit: paths.dataOperationAuditIndexJs,
        ...
        output: {
            ...
            publicPath: isEnvProduction
                ? `/anyfabric${paths.publicUrlOrPath}`
                ...
                },
                {
                    ...
                    oneOf: [
                        ...
                        // that fall through the other loaders.
                        {
                            ...
                            exclude: [
                                /^$/,
                                /\.(js|mjs|jsx|ts|tsx|woff|woff2|eot|ttf|otf)$/,
                                /\.html$/,
                                /\.json$/,
                            ],
                            type: 'asset/resource',
        ...
        plugins: [
            ...
            ...entryFiles.map(({ name, template, htmlFilename }) => new HtmlWebpackPlugin(
                ({
            ...
            new WebpackManifestPlugin({
                ...
                generate: (seed, files, entrypoints) => {
                    ...
                    // )
                    let entrypointFiles = []
                    for (const [entryFile, fileName] of Object.entries(entrypoints)) {
                        const notMapFiles = fileName.filter(fileName => !fileName.endsWith('.map'))
