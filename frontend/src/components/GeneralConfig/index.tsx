...
const GeneralConfig = () => {
    ...
    return (
        <div className={styles.generalConfigWrap}>
            ...
            {using === 1 && (
                <>
                    {/* <div className={styles.title}>{__('共享配置')}</div>
                    <div className={styles.configItem}>
                        <div className={styles.text}>
                            <div className={styles.textTitle}>
                                {__('一体化政务数据共享')}
                        ...
                        <div>
                            <Switch
                                onChange={(value) => {
                                    if (value) {
                                        setGovernmentSwitchStatus(value)
                                        setGovernmentConfig(value)
                                    } else {
                                        confirm({
                                            title: __('确认要关闭此功能吗？'),
                                            content:
                                ...
                                checked={governmentSwitchStatus}
                            />
                        </div>
                    </div> */}
                    {/* <div className={styles.title}>{__('应用配置')}</div>
                    <div className={styles.configItem}>
                        <div className={styles.text}>
                            <div className={styles.textTitle}>
                                {__('生成本地应用凭证')}
                        ...
                        <div>
                            <Switch
                                ...
                                checked={localAppSwitchStatus === 'true'}
                            />
                        </div>
                    </div> */}
