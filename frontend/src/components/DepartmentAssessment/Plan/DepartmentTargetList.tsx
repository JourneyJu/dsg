...
interface DepartmentTargetListProps {
    onSelectTarget: (id: string) => void
    initTargetList: IAssessmentTargetItem[]
    departmentId: string
}

const DepartmentTargetList = ({
    onSelectTarget,
    initTargetList = [],
    departmentId = '',
}: DepartmentTargetListProps) => {
    ...
    return (
        <div className={styles['department-target-list']}>
            <div className={styles.title}>{__('我的部门目标')}</div>
...
export default DepartmentTargetList
