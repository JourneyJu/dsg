...
import { formatError, dataAnalStartFeedback } from '@/core'
import {
    ContactView,
    MultiColumn,
    SubTitle,
} from '@/components/DataAnalysis/helper'
...
const StartFeedback = ({ data, open, onClose, onOk }: StartFeedbackProps) => {
    ...
    const onFinish = async (values: any) => {
        try {
            await dataAnalStartFeedback({
                data_anal_req_ids: dataSource.map((item) => item.id),
