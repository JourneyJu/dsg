...
import DepartmentMutiSelected from './DepartmentMutiSelected'
import { AuditLogType, LogLevel, logOption } from './helper'
import { getPlatformNumber, useQuery } from '@/utils'
import UserSelect from './UserSelected'
...
const FilterView: React.FC<IFilterView> = ({ condition$ }) => {
    ...
    const handleSearch = () => {
        try {
            ...
            const allValues = {
                ...
                levels:
                    levels === 0 ? [LogLevel.INFO, LogLevel.WARN] : [levels],
            }
            const params = {}
    ...
    const levelOptions = [
        { value: 0, label: __('全部') },
        { value: LogLevel.INFO, label: __('信息') },
        { value: LogLevel.WARN, label: __('警告') },
    ]
    ...
    return (
        <div className={styles.logFilter}>
            ...
            <div className={styles['logFilter-content']}>
                ...
                >
                    <Form.Item label={__('用户/应用')} name="operator_names">
                    ...
                    <Form.Item label={__('操作类型')} name="operations">
                        <Select
                            ...
                            options={
                                logOption(platform !== LoginPlatform.default)[
                                    tab
                                ].options
                            }
