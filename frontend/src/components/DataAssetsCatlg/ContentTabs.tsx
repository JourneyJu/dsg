...
import { TabsProps, Tabs, Tooltip, BackTop } from 'antd'
import classnames from 'classnames'
import styles from './styles.module.less'
import { IRescBasicInfo, ServiceType, DataCatlgTabKey } from './helper'
import DataCatlgAbstract from './DataCatlgAbstract'
import DataUndsReport from './DataUndsReport'
import DataCatlgTableInfo from './DataCatlgTableInfo'
...
import { DataServiceType, ResourceType } from '../ResourcesDir/const'
